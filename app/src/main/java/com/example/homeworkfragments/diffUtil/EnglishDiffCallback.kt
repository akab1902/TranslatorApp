...
class EnglishDiffCallback: DiffUtil.Callback() {
    private var oldList = emptyList<TranslatedMessage>()
    private var newList = emptyList<TranslatedMessage>()

    fun setItems(oldList: List<TranslatedMessage>, newList: List<TranslatedMessage>) {
